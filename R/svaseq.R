...
svaseq <- function(dat, mod, mod0 = NULL,n.sv=NULL,controls=NULL,method=c("irw","two-step","supervised"),
  ...
  if(n.sv > 0){
    message(paste("Number of significant surrogate variables is: ", n.sv, "."))
    ...
    message("No significant surrogate variables."); return(list(sv=0,pprob.gam=0,pprob.b=0,n.sv=0))
  }
